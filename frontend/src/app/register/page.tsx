...
export default function Register() {
  return (
    <div className="items-center min-h-screen max-h-screen overflow-hidden">
      <Image
      ...
      <main className="flex relative flex-col items-center justify-center w-3/12 flex-1 px-20 text-center lg:left-1/4 sm:w-[95vw] xs:w-[90vw] min-h-screen py-2">
